	...
	public static function page_settings() {
		...
		<section class="rz-card">
			...
			<ul class="rz-list">
				...
				<li>Elementor (kategori <strong>Rakan Zakat</strong>): Borang Zakat, Kalkulator Zakat, Panduan &amp; Taksiran, Kategori Zakat, Tiga Langkah, Saluran Rasmi, Impak Komuniti, FAQ, CTA Bayar</li>
